...
public class ProductController {
	...
	public String homeProduct(Model model, HttpServletRequest request){
		...
		model.addAttribute("greetings","hello world product");
	...
	@RequestMapping(value="/product/shopping_cart/{productId}")
	public String prodAddToCat(@PathVariable("productId") String productId,Model model, HttpServletRequest request){
		model.addAttribute("productCatList",productDao.getProductById(productId));
		System.out.println("productid of product"+productId);
		//model.addAttribute("ProductList",productDao.listProduct());
		return "shopping_cart";
	}
	
	@RequestMapping(value="/admin/editproduct/{productId}")
	public String admineditProduct(Model model,@PathVariable ("productId") String productId ){
	...
	public String addProduct(@ModelAttribute("product") Product product,Model model,MultipartFile file){
	 ...
	 public String adminremoveProduct(Model model, @PathVariable ("productId") String productId) {
